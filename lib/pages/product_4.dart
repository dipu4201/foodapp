...
class Product4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(18.9, 28, 7, 34),
        child: Stack(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(0, 0, 12, 61),
                    child: Row(
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(16.1, 0, 0, 55.5),
                    child: SizedBox(
                      height: 277.5,
                      child: Container(
                        padding: EdgeInsets.fromLTRB(31.5, 220.6, 31.5, 16.5),
                        child: Stack(
                          clipBehavior: Clip.none,
                          children: [
                            ImageFiltered(
                            ...
                            Positioned(
                              ...
                              child: ImageFiltered(
                                ...
                                child: SizedBox(
                                  ...
                                  height: 75.5,
                                  child: SvgPicture.asset(
                                    'assets/vectors/ellipse_9_x2.svg',
                                  ),
                                ),
                              ),
                            ),
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0.1, 0, 26.7, 88),
                    child: Text(
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0.1, 0, 12, 73),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: SizedBox(
                                ...
                                height: 14,
                                child: SvgPicture.asset(
                                  'assets/vectors/group_202_x2.svg',
                                ),
                              ),
                            ),
                            Container(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      margin: EdgeInsets.fromLTRB(0, 8, 14.2, 8),
                                      child: Text(
                                        '4',
                                        style: GoogleFonts.getFont(
                                          'Inter',
                                    ...
                                    Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: SizedBox(
                                          ...
                                          height: 10,
                                          child: SvgPicture.asset(
                                            'assets/vectors/group_233_x2.svg',
                                          ),
                                        ),
                                      ),
                                    ),
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            child: Container(
                              padding: EdgeInsets.fromLTRB(17, 20, 17.9, 20),
                              child: Text(
                                '\$26.99',
                                style: GoogleFonts.getFont(
                                  'Roboto',
