...
class Product3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(15, 28, 15, 34),
        child: Stack(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(3.9, 0, 4, 1),
                    child: Row(
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0, 0, 0, 25.8),
                    child: SizedBox(
                      height: 367.2,
                      child: Container(
                        padding: EdgeInsets.fromLTRB(4, 280.6, 0, 46.2),
                        child: Stack(
                          clipBehavior: Clip.none,
                          children: [
                            ImageFiltered(
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(4, 0, 4, 19),
                    child: Align(
                      alignment: Alignment.topLeft,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(4, 0, 32.1, 69),
                    child: Text(
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(4, 0, 4, 73),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
